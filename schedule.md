...
<td markdown="span">
<a href="{{ site.baseurl }}/slides/01_introduction.pdf">Slides</a></td>
</tr>
<tr>
<td markdown="span">
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> <b> Lab 0 </b> Development Setup </li>
</ul>{:/}
</td>
<td markdown="span">
<a href="{{ site.baseurl }}/labs/lab0">Lab instructions</a></td>
</tr>
<tr>
...
<td markdown="span">
<a href="{{ site.baseurl }}/slides/15_udp.pdf">Slides</a></td>
</tr>
<tr>
<td markdown="span">
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> TCP State-Exhaustion Attacks & Defenses </li>
</ul>{:/}
</td>
<td markdown="span">
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> No Class. Enjoy the break! </li>
</ul>{:/}
</td>
<td markdown="span">
</td>
...
<td markdown="span">
<a href="{{ site.baseurl }}/slides/27_vpn_i.pdf">Slides</a></td>
</tr>
<tr>
<td markdown="span">
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> Virtual Private Network II </li>
</ul>{:/}
</td>
<td markdown="span">
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> Josh and William Present </li>
</ul>{:/}
</td>
<td markdown="span">
</td>
...
<td markdown="span" style="text-align:left">
{::nomarkdown}<ul style="margin:0;padding:.5rem">
<li> Abhinav and Andrew Present </li>
</ul>{:/}
</td>
<td markdown="span">
</td>
